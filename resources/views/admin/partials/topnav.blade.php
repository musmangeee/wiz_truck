<nav class="navbar navbar-expand-lg " id="topnav">
    <div class="container">
        ...
        <!-- Brand -->
        <a class="navbar-brand mr-auto" href="{{route('user.index')}}">
            <img src="{{ asset('frontend/img/logos/logo-2.png')}}" alt="..." class="navbar-brand-img">
        </a>
        ...
        <div class="collapse navbar-collapse mr-lg-auto order-lg-first" id="navbar">
            ...
            <ul class="navbar-nav mr-lg-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('add_business') }}">
                        For Businesses
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('search_business') }}">
                        Write a Review
                    </a>
                </li>
            </ul>
