                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item pr-lg-2">
                            <a href="{{ url('my/business/create') }}" class="nav-link text-dark">Business Reviews</a>
                        </li>
                        <li class="nav-item pr-lg-3">
                            <a href="{{url('business/setting')}}" class="nav-link text-dark">Business Settings</a>
                        </li>
        ...
        <div class="row h-100">
            <form action="{{route('search')}}" method="GET" class="col-12">
                <div class="input-group mb-3">
                    <input type="text" class="autocomplete_find form-control" name="category" autocomplete="off" placeholder="tacos, cheap dinner, Max’s">
